	 ...
	 class="segmented-control">
        ...
        backgroundColor: index === currentIndex && styleType === 'button' ? activeColor : '',borderColor: index === currentIndex&&styleType === 'text'||styleType === 'button'?activeColor:'transparent'
		 ...
		 class="segmented-control__item" @click="_onClick(index)">
			<text :style="{color: index === currentIndex  ? styleType === 'text'  ? activeColor : '#fff': styleType === 'text'  ? '#000'  : activeColor, borderColor: index === currentIndex  ? styleType === 'text'  ? activeColor : '#fff': styleType === 'text'  ? '#fff'  : activeColor, borderBottomWidth: index === currentIndex  ? styleType === 'text'  ? activeColor : '#fff': styleType === 'text'  ? '0px'  : '3px'}"
